...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'auth.departement' => \App\Http\Middleware\AuthenticateDepartement::class,
        'guest.departement' => \App\Http\Middleware\RedirectIfAuthenticateDepartement::class,
    ];
    protected $commands = [
        \App\Console\Commands\UpdateAdminPassword::class,
    ];
}
